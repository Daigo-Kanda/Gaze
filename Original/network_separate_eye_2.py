...
from tensorflow.keras.layers import Input, Conv2D, Dense, Flatten, MaxPool2D, concatenate, BatchNormalization, Activation
...
def get_eye_model(img_ch, img_cols, img_rows):
    ...
    h = Conv2D(96, (11, 11), strides=4)(eye_img_input)
    ...
    out = Conv2D(64, (1, 1), strides=1, padding='same',
                 activation=activation)(h)
...
def get_face_model(img_ch, img_cols, img_rows):
    ...
    h = Conv2D(96, (11, 11), strides=4)(face_img_input)
    h = BatchNormalization()(h)
    h = Activation('relu')(h)
